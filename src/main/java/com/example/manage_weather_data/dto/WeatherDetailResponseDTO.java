...
public class WeatherDetailResponseDTO {
    ...
    public WeatherDetailResponseDTO() {
    }

    public WeatherDetailResponseDTO(Double temp, Double feelsLike, Double tempMin, Double tempMax, Integer pressure,
    ...
    public boolean equals(Object o) {
        ...
        WeatherDetailResponseDTO that = (WeatherDetailResponseDTO) o;
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("WeatherDetailResponseDTO{");
